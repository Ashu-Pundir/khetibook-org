  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-2 sidebar position-sticky sticky-top">
        ...
        <a href="{{ route('admincheck.price') }}" class="{{ request()->is('my-crops') ? 'active' : '' }}" ><i class="fa-solid fa-wheat-awn"></i> <span>Market Price</span>
        </a>
    ...
    <div class="col-md-10 col-sm-12 main-content">
      ...
      <div class="card p-4 shadow rounded col-md-12">
        ...
        <form method="POST" action="{{ route('submit.admincheckprice') }}" class="mb-4">
          @csrf
