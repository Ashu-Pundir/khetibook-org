                ...
                <div class="col-md-8">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <input type="text" name="email_verified" class="form-control"
                                value="{{ $user->email_verified ? '1' : '0' }}">
                        </div>
                        <div class="col-md-6 mt-3">
                            <label class="form-label">Number Verified</label>
                            <input type="text" name="number_verified" class="form-control"
                                value="{{ $user->number_verified ? '1' : '0' }}">
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.crop.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="crop_category" class="form-select" required>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Crop Quantity (kg)</label>
                                <input type="number" step="0.01" name="crop_weight" class="form-control"
                                    required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Crop Price (₹)</label>
                                <input type="number" step="0.01" name="crop_price" class="form-control"
                                    required>
                            </div>
                        </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        @forelse($crop as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                        data-bs-target="#editCropModal{{ $item->id }}">
                                        ✏️
                                    </button>

                                    <!-- Delete Icon -->
                                    <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal"
                                        data-bs-target="#deleteCropModal{{ $item->id }}">
                                        🗑️
                                    </button>
                                </td>
                            </tr>
                            ...
                            <!-- Edit Modal -->
                            <div class="modal fade" id="editCropModal{{ $item->id }}" tabindex="-1"
                                aria-labelledby="editCropLabel{{ $item->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.crop.update', $item->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="crop_category" class="form-select" required>
                                                        <option value="">-- Select Category --</option>
                                                        <option value="Cereals (Atta)"
                                                            {{ $item->crop_category == 'Cereals (Atta)' ? 'selected' : '' }}>
                                                            Cereals (Atta)</option>
                                                        <option value="Pulses (Daal)"
                                                            {{ $item->crop_category == 'Pulses (Daal)' ? 'selected' : '' }}>
                                                            Pulses (Daal)</option>
                                                        <option value="Vegetables"
                                                            {{ $item->crop_category == 'Vegetables' ? 'selected' : '' }}>
                                                            Vegetables</option>
                                                        <option value="Fruits"
                                                            {{ $item->crop_category == 'Fruits' ? 'selected' : '' }}>
                                                            Fruits</option>
                                                        <option value="Spices"
                                                            {{ $item->crop_category == 'Spices' ? 'selected' : '' }}>
                                                            Spices</option>
                                                        <option value="Cash/Commercial"
                                                            {{ $item->crop_category == 'Cash/Commercial' ? 'selected' : '' }}>
                                                            Cash/Commercial</option>
                                                        <option value="Other"
                                                            {{ $item->crop_category == 'Other' ? 'selected' : '' }}>
                                                            Other</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Crop Quantity (kg)</label>
                                                    <input type="number" step="0.01" name="crop_weight"
                                                        class="form-control" value="{{ $item->crop_weight }}"
                                                        required>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">Crop Price (₹)</label>
                                                    <input type="number" step="0.01" name="crop_price"
                                                        class="form-control" value="{{ $item->crop_price }}"
                                                        required>
                                                </div>
                                            </div>
                            ...
                            <!-- Delete Modal -->
                            <div class="modal fade" id="deleteCropModal{{ $item->id }}" tabindex="-1"
                                aria-labelledby="deleteCropLabel{{ $item->id }}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.crop.destroy', $item->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <p>Are you sure you want to delete the crop
                                                    <strong>{{ $item->crop_name }}</strong>?</p>
                                            </div>
                                            <div class="modal-footer">
